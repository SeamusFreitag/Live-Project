...
- [Malware Deep Investigation](./defensive/08-malware-deep-investigation/) - PCAP + IDS alert triage on an AD network: Kerberos host/user identification, Ursnif banking trojan confirmed by signature and C2 behavior, delivery traced from a webmail phishing email through an ad-redirect chain to encrypted `/api1/` C2